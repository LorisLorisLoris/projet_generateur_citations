...
let citations = [["La vie est un mystère qu'il faut vivre, et non un problème à résoudre.", "Gandhi"],
...
btn.addEventListener("click",() => {
  ...
  divCitation.innerHTML = citations[nombreAleatoire][0];
  divAuteur.innerHTML   = citations[nombreAleatoire][1];
